...
const ListItem = ({ portfolio }) => {
    return (
        <div className="flex hover:shadow-xl mx-2 w-158 border p-4 border-white border-b-gray-400 hover:rounded-lg hover:border-gray-400 hover:text-blue-500">
            <img
                className="w-16 h-16 mr-2 rounded-sm"
                src={LOGO_URL + portfolio.scid + ".png"}
                alt=""
            />
            <div className="flex flex-col mx-2 w-126">
